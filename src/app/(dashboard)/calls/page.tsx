    ...
    <>
      <div className="max-w-6xl mx-auto pb-8 space-y-5">
        ...
        <div className="flex flex-wrap items-end justify-between gap-3">
          <div>
            <h1 className="text-2xl font-bold text-neutral-900 tracking-tight">Calls</h1>
...
function CallRow({ log, onOpen }: { log: CallLog; onOpen: () => void }) {
  ...
  return (
    ...
    >
      <td className="px-5 py-3.5">
        <div className="flex items-center gap-2.5">
          ...
          <div className="min-w-0">
            <p className="text-sm font-medium text-neutral-900 truncate max-w-[260px]">
              {caller}
            </p>
      ...
      <td className="px-5 py-3.5 text-right font-mono text-[12px] text-neutral-700 whitespace-nowrap">
      ...
      <td className="px-5 py-3.5">
        {log.appointment_id ? (
          ...
          <span className="inline-flex items-center px-2 py-0.5 rounded-full bg-neutral-50 text-neutral-500 text-[10px] font-semibold uppercase tracking-wider border border-neutral-100">
            —
          </span>
        )}
      </td>
