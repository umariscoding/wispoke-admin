...
function SetupRequiredBanner({
  ...
  return (
    <div className="mb-8">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 shadow-sm">
        {/* Accent bar at top */}
        ...
        <div className="relative px-8 py-10">
          <div className="flex items-start gap-8">
            ...
            <div className="flex-shrink-0">
              <div className="relative">
                ...
                <div className="relative w-14 h-14 rounded-xl bg-gradient-to-br from-primary-500/20 to-primary-600/20 flex items-center justify-center border border-primary-500/30 backdrop-blur-sm">
                  <Icons.CheckCircle className="h-7 w-7 text-primary-600 dark:text-primary-400" />
                </div>
              </div>
            </div>
            ...
            <div className="flex-1 min-w-0">
              <div className="mb-1">
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-primary-50 dark:bg-primary-900/20 border border-primary-200 dark:border-primary-900/40">
                  <span className="w-1.5 h-1.5 rounded-full bg-primary-600" />
                  <span className="text-xs font-medium text-primary-700 dark:text-primary-300">Setup Required</span>
                </span>
              </div>

              <h3 className="text-xl font-semibold text-neutral-900 dark:text-neutral-50 mt-3 mb-2">
                  ...
                  <div key={idx} className="flex items-center gap-3 group">
                    <div className="flex-shrink-0 flex items-center justify-center">
                      <div className="w-6 h-6 rounded-full bg-primary-100 border border-primary-300 flex items-center justify-center">
                        <span className="text-xs font-bold text-primary-700 dark:text-primary-300">{idx + 1}</span>
                      </div>
                    </div>
  ...
  return (
    <div className="max-w-7xl mx-auto animate-in">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-neutral-900 dark:text-neutral-50">Embed Widget</h1>
      ...
      {slug && isPublished && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-5">
            ...
            <div className={`bg-white dark:bg-neutral-900 rounded-lg border border-neutral-200 dark:border-neutral-800 p-5 space-y-5 ${isFree ? "opacity-50 pointer-events-none select-none" : ""}`}>
              <div>
                <p className="text-sm font-semibold text-neutral-900 dark:text-neutral-50">Appearance</p>
                      ...
                      >
                        <div
                          className={`w-3 h-3 rounded-sm ${
                            t === "light" ? "bg-neutral-100 dark:bg-neutral-800" : "bg-neutral-700"
                          }`}
                        />
                      </div>
              ...
              <div>
                ...
                <div className="mt-1.5 flex gap-2">
                  {(["right", "left"] as const).map((pos) => (
                    ...
                    >
                      <div className="w-7 h-5 rounded border border-neutral-300 dark:border-neutral-700 relative bg-white dark:bg-neutral-900">
                        <div
                ...
                <div className="mt-1.5 flex items-center gap-2 flex-wrap">
                  ...
                  <div className="flex items-center gap-1.5 ml-1">
                    ...
                    <input
                      ...
                      value={settings.primaryColor}
                      onChange={(e) => updateSetting("primaryColor", e.target.value)}
                      className="w-20 px-2 py-1.5 text-xs border border-neutral-200 dark:border-neutral-800 rounded-lg font-mono focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-400"
                      placeholder="#0d9488"
                    />
                  </div>
                </div>
            ...
            <div className={`bg-white dark:bg-neutral-900 rounded-lg border border-neutral-200 dark:border-neutral-800 p-5 space-y-5 ${isFree ? "opacity-50 pointer-events-none select-none" : ""}`}>
              <div>
                <p className="text-sm font-semibold text-neutral-900 dark:text-neutral-50">Content</p>
                <p className="text-xs text-neutral-500 dark:text-neutral-400 mt-0.5">
              ...
              <div>
                ...
                <input
                  ...
                  className="mt-1.5 w-full rounded-lg border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 text-neutral-900 dark:text-neutral-50 placeholder-neutral-400 dark:placeholder-neutral-500 px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-400 transition-all"
              ...
              <div>
                ...
                <label className="flex items-center gap-2 mt-2 cursor-pointer">
                  <input
                    ...
                    className="rounded border-neutral-300 dark:border-neutral-700 text-primary-600 dark:text-primary-400 focus:ring-primary-500/20"
                  />
                  <span className="text-xs text-neutral-500 dark:text-neutral-400">Show in header</span>
                </label>
              </div>
              ...
              <div>
                ...
                <p className="text-xs text-neutral-400 dark:text-neutral-500 mt-0.5 mb-2">
                ...
                <div className="space-y-2">
                  {(settings.suggestedMessages || []).map((msg, idx) => (
                    <div key={idx} className="flex gap-2">
                      <input
                        ...
                        className="flex-1 rounded-lg border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 text-neutral-900 dark:text-neutral-50 placeholder-neutral-400 dark:placeholder-neutral-500 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-400 transition-all"
                      ...
                      <button
                        ...
                        className="flex-shrink-0 w-9 h-9 rounded-lg border border-neutral-200 dark:border-neutral-800 flex items-center justify-center text-neutral-400 dark:text-neutral-500 hover:text-red-500 hover:border-red-200 transition-colors"
                      >
                  ...
                  {(settings.suggestedMessages || []).length < 6 && (
                    <button
                      ...
                      className="w-full rounded-lg border border-dashed border-neutral-300 dark:border-neutral-700 py-2 text-xs text-neutral-500 dark:text-neutral-400 hover:text-primary-600 dark:hover:text-primary-400 hover:border-primary-300 transition-colors"
                    >
            ...
            <div className={`bg-white dark:bg-neutral-900 rounded-lg border border-neutral-200 dark:border-neutral-800 p-5 space-y-5 ${isFree ? "opacity-50 pointer-events-none select-none" : ""}`}>
              <div>
                <p className="text-sm font-semibold text-neutral-900 dark:text-neutral-50">Chat Style</p>
                <p className="text-xs text-neutral-500 dark:text-neutral-400 mt-0.5">
                      ...
                      >
                        ...
                        <div className="bg-neutral-950 px-3 pt-4 pb-2 flex justify-center">
                          ...
                          >
                            ...
                            {tpl.value === "default" && (
                              <div className="bg-white dark:bg-neutral-900 rounded-lg overflow-hidden shadow-lg shadow-black/20" style={{ aspectRatio: "7/10" }}>
                                {/* Header */}
                                <div className="px-2 py-1.5 flex items-center justify-between" style={{ background: settings.headerColor || settings.primaryColor }}>
                                  ...
                                  <div className="w-2.5 h-2.5 rounded flex items-center justify-center bg-white/10 dark:bg-neutral-900/10">
                                    <div className="w-1.5 h-px bg-white/70 dark:bg-neutral-900/70" />
                                  </div>
                                </div>
                                {/* Messages */}
                                <div className="px-1.5 py-1.5 flex flex-col gap-1 flex-1">
                                  <div className="self-start">
                                    <div className="text-[5px] text-neutral-500 dark:text-neutral-400 leading-tight">How can I help?</div>
                                  </div>
                                  <div className="self-end">
                                    <div className="text-[5px] bg-neutral-100 dark:bg-neutral-800 rounded-full px-1.5 py-0.5 text-neutral-700 dark:text-neutral-300 leading-tight">I have a question</div>
                                  </div>
                                  <div className="self-start">
                                    <div className="text-[5px] text-neutral-500 dark:text-neutral-400 leading-tight">Sure, go ahead!</div>
                                  </div>
                                </div>
                                {/* Input */}
                                <div className="px-1.5 pb-1.5">
                                  <div className="bg-neutral-100 dark:bg-neutral-800 rounded-full h-3.5 flex items-center px-1.5">
                                    <div className="text-[4px] text-neutral-400 dark:text-neutral-500">Type a message...</div>
                                  </div>
                                </div>
                              </div>
                            )}
                            ...
                            {tpl.value === "bubbles" && (
                              <div className="bg-white dark:bg-neutral-900 rounded-xl overflow-hidden shadow-lg shadow-black/20" style={{ aspectRatio: "7/10" }}>
                                {/* Header */}
                                <div className="px-2 py-2 flex items-center gap-1.5" style={{ background: settings.headerColor || settings.primaryColor }}>
                                  <div className="w-4 h-4 rounded-full bg-white/20 dark:bg-neutral-900/20 flex items-center justify-center">
                                ...
                                <div className="px-1.5 py-1.5 flex flex-col gap-1 flex-1">
                                  <div className="self-start flex items-end gap-0.5">
                                    ...
                                    <div className="text-[5px] bg-neutral-100 dark:bg-neutral-800 rounded-lg rounded-bl-sm px-1.5 py-0.5 text-neutral-700 dark:text-neutral-300 leading-tight">How can I help?</div>
                                  </div>
                                  <div className="self-end">
                                  ...
                                  <div className="self-start flex items-end gap-0.5">
                                    ...
                                    <div className="text-[5px] bg-neutral-100 dark:bg-neutral-800 rounded-lg rounded-bl-sm px-1.5 py-0.5 text-neutral-700 dark:text-neutral-300 leading-tight">Sure, go ahead!</div>
                                  </div>
                                </div>
                                {/* Input */}
                                <div className="px-1.5 pb-1.5">
                                  <div className="bg-neutral-100 dark:bg-neutral-800 rounded-full h-3.5 flex items-center justify-between px-1.5">
                                    <div className="text-[4px] text-neutral-400 dark:text-neutral-500">Type a message...</div>
                            ...
                            {tpl.value === "minimal" && (
                              <div className="bg-white dark:bg-neutral-900 rounded overflow-hidden shadow-lg shadow-black/20" style={{ aspectRatio: "7/10" }}>
                                {/* Header */}
                                <div className="px-2 py-1.5 flex items-center gap-1 border-b border-neutral-200 dark:border-neutral-800">
                                  <div className="w-3 h-3 rounded flex-shrink-0 flex items-center justify-center" style={{ background: settings.primaryColor }}>
                                    <div className="text-[4px] text-white font-bold">A</div>
                                  </div>
                                  <div>
                                    <div className="text-[6px] font-semibold text-neutral-800 dark:text-neutral-100 leading-tight">Chat</div>
                                    <div className="text-[4px] text-neutral-400 dark:text-neutral-500 leading-tight">Online</div>
                                  </div>
                                </div>
                                {/* Messages */}
                                <div className="px-1.5 py-1 flex flex-col gap-0.5 flex-1">
                                  <div className="self-start">
                                    <div className="text-[5px] text-neutral-500 dark:text-neutral-400 py-0.5 leading-tight">How can I help?</div>
                                  </div>
                                  <div className="self-end">
                                    <div className="text-[5px] bg-neutral-50 dark:bg-neutral-950 rounded px-1.5 py-0.5 text-neutral-700 dark:text-neutral-300 leading-tight">I have a question</div>
                                  </div>
                                  <div className="self-start">
                                    <div className="text-[5px] text-neutral-500 dark:text-neutral-400 py-0.5 leading-tight">Sure, go ahead!</div>
                                  </div>
                                </div>
                                {/* Input */}
                                <div className="px-1.5 pb-1.5">
                                  <div className="border border-neutral-200 dark:border-neutral-800 rounded h-3.5 flex items-center justify-between px-1.5">
                                    <div className="text-[4px] text-neutral-400 dark:text-neutral-500">Type a message...</div>
                        ...
                        {/* Label area */}
                        <div className={`px-3 py-2.5 transition-colors ${isActive ? "bg-primary-50/50 dark:bg-primary-900/20" : "bg-white dark:bg-neutral-900"}`}>
                          <div className="flex items-center gap-1.5">
                            {isActive && (
                              <div className="w-1.5 h-1.5 rounded-full bg-primary-500 flex-shrink-0" />
                            )}
                            <p className={`text-sm font-semibold ${isActive ? "text-primary-700 dark:text-primary-300" : "text-neutral-800 dark:text-neutral-100"}`}>
                              {tpl.label}
                            </p>
                          </div>
            ...
            <div className={`bg-white dark:bg-neutral-900 rounded-lg border border-neutral-200 dark:border-neutral-800 overflow-hidden ${isFree ? "opacity-50 pointer-events-none select-none" : ""}`}>
              <div className="p-5 border-b border-neutral-100 dark:border-neutral-800">
                <p className="text-sm font-semibold text-neutral-900 dark:text-neutral-50">Behavior</p>
                <p className="text-xs text-neutral-500 dark:text-neutral-400 mt-0.5">
              ...
              <div className="p-5 space-y-4">
                    ...
                    return (
                      <button
                        ...
                        className={`group flex flex-col items-center gap-1.5 py-2.5 px-1 rounded-xl border transition-all duration-150 ${
                          isActive
                            ? "bg-primary-50 dark:bg-primary-900/20 border-primary-300 shadow-sm shadow-primary-500/10"
                            : "border-transparent hover:border-neutral-200 dark:hover:border-neutral-800 hover:bg-neutral-50 dark:hover:bg-neutral-800"
                        }`}
                      >
                        <div
                          className={`w-9 h-9 flex items-center justify-center transition-all ${
                            ...
                            isActive
                              ...
                              : "bg-neutral-100 dark:bg-neutral-800 group-hover:bg-neutral-200 dark:group-hover:bg-neutral-800"
                          }`}
                        >
                          <opt.icon
                            className={`w-[18px] h-[18px] transition-colors ${
                              isActive ? "text-white" : "text-neutral-500 dark:text-neutral-400 group-hover:text-neutral-700 dark:group-hover:text-neutral-300"
                            }`}
                          />
                        </div>
                        <span
                          className={`text-[10px] font-semibold leading-none transition-colors ${
                            isActive ? "text-primary-700 dark:text-primary-300" : "text-neutral-400 dark:text-neutral-500 group-hover:text-neutral-600 dark:group-hover:text-neutral-400"
                          }`}
                        >
                          {opt.label}
                        </span>
                ...
                <div className="relative rounded-xl overflow-hidden border border-neutral-200 dark:border-neutral-800">
                  {/* Mini browser chrome */}
                  <div className="flex items-center gap-1.5 px-3 py-2 bg-neutral-100 dark:bg-neutral-800 border-b border-neutral-200 dark:border-neutral-800">
                    <div className="flex gap-1">
                      <div className="w-2 h-2 rounded-full bg-neutral-300" />
                      <div className="w-2 h-2 rounded-full bg-neutral-300" />
                      <div className="w-2 h-2 rounded-full bg-neutral-300" />
                    </div>
                    <div className="flex-1 mx-2 h-4 rounded-md bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 flex items-center px-2">
                      <span className="text-[8px] text-neutral-400 dark:text-neutral-500 font-mono">yourwebsite.com</span>
                    </div>
                  </div>
              ...
              {/* Hide Branding */}
              <div className="mx-5 mb-5 flex items-center justify-between rounded-xl border border-neutral-200 dark:border-neutral-800 px-4 py-3.5">
                <div className="flex items-center gap-3">
                  <div className={`w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 ${settings.hideBranding ? "bg-primary-50 dark:bg-primary-900/20" : "bg-neutral-100 dark:bg-neutral-800"}`}>
                    <Icons.Eye className={`h-4 w-4 ${settings.hideBranding ? "text-primary-600 dark:text-primary-400" : "text-neutral-400 dark:text-neutral-500"}`} />
                  </div>
                  <div>
                ...
                >
                  <span
                    className={`absolute top-0.5 left-0.5 bg-white dark:bg-neutral-900 rounded-full shadow-sm transition-transform duration-200 ${
          ...
          <div className="lg:sticky lg:top-4 h-fit">
            <div className="rounded-lg border border-neutral-200 dark:border-neutral-800 overflow-hidden">
              <div className="flex items-center justify-between p-5 border-b border-neutral-100 dark:border-neutral-800 bg-white dark:bg-neutral-900">
              ...
              <div className="px-5 py-3 border-t border-neutral-100 dark:border-neutral-800 bg-white dark:bg-neutral-900">
