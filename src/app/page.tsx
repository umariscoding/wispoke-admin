...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-white/[0.02] text-slate-900 dark:text-white overflow-x-hidden">
      {/* ═══════════ NAV ═══════════ */}
      <nav
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          scrolled
            ? "bg-white/80 dark:bg-white/[0.02] backdrop-blur-2xl shadow-[0_1px_3px_rgba(0,0,0,0.08)]"
            : ""
        }`}
      >
            ...
            {isLoggedIn ? (
              ...
              <>
                <Link
                  ...
                  className="hidden sm:inline-flex items-center justify-center text-sm font-medium text-slate-600 dark:text-slate-400 border border-neutral-200 hover:border-slate-300 dark:border-white/[0.10] dark:hover:border-white/[0.10] rounded-full h-10 px-5 transition-colors"
                >
                  Login
                </Link>
                <Link
      ...
      <section className="relative pt-28 sm:pt-36 lg:pt-48 pb-0 overflow-hidden">
        ...
        <div
          ...
          aria-hidden="true"
        >
          <div className="absolute top-24 -left-8 w-28 h-28 sm:w-44 sm:h-44 bg-primary-100/40 dark:bg-teal-500/15 rounded-3xl rotate-12" />
          ...
          <div className="absolute bottom-[40%] left-[20%] w-32 h-32 sm:w-52 sm:h-52 bg-primary-100/25 dark:bg-teal-500/15 rounded-3xl rotate-45" />
          ...
          <div className="absolute bottom-[30%] right-6 sm:right-16 w-24 h-24 sm:w-40 sm:h-40 bg-primary-100/30 dark:bg-teal-500/15 rounded-3xl rotate-6" />
        ...
        <div className="relative max-w-4xl mx-auto text-center px-5 sm:px-6">
          <h1 className="animate-slide-up text-[2.5rem] sm:text-6xl lg:text-7xl font-bold tracking-tight leading-[1.05] sm:leading-[1.1] text-slate-900 dark:text-white mb-5 sm:mb-6">
            Your AI support,
            <br />
            deployed on
            <br />
          ...
          <p className="animate-slide-up-d1 text-base sm:text-xl text-slate-500 dark:text-slate-400 max-w-2xl mx-auto mb-8 sm:mb-10 leading-relaxed px-2">
          ...
          <div className="animate-slide-up-d2 flex flex-col sm:flex-row items-center justify-center gap-4 mb-12 sm:mb-16 lg:mb-24">
            {isLoggedIn ? (
              ...
              <>
                ...
                <Link
                  href={ROUTES.COMPANY_LOGIN}
                  className="text-sm text-slate-400 dark:text-slate-400 hover:text-slate-600 dark:hover:text-slate-400 transition-colors"
                >
      ...
      {/* ═══════════ TRUST ═══════════ */}
      <section className="relative py-10 sm:py-14 px-5 sm:px-6 border-y border-slate-100 dark:border-white/[0.06]">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center justify-center gap-5 sm:gap-14 flex-wrap">
            {[
              ...
              <div key={item.text} className="flex items-center gap-2 text-slate-400 dark:text-slate-400">
      ...
      <section className="relative py-20 sm:py-24 lg:py-36 px-5 sm:px-6">
        <div className="max-w-6xl mx-auto">
          <div className="scroll-reveal">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-slate-900 dark:text-white mb-10 sm:mb-16 max-w-xl">
          ...
          <div className="scroll-reveal grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-5 lg:auto-rows-[240px]">
            ...
            <div className="lg:col-span-2 lg:row-span-2 bg-neutral-50 dark:bg-transparent rounded-3xl overflow-hidden relative flex flex-col lg:min-h-0">
              <div className="p-6 sm:p-8 lg:p-10 relative z-10">
                <span className="inline-block text-[11px] font-semibold uppercase tracking-widest text-slate-500 dark:text-slate-400 border border-neutral-200 dark:border-white/[0.06] rounded-full px-3 py-1 mb-4 sm:mb-5">
                  Platform
                </span>
                <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-slate-900 dark:text-white max-w-sm leading-snug">
            ...
            {/* Top-right — stat card */}
            <div className="bg-neutral-50 dark:bg-transparent rounded-3xl p-6 sm:p-8 flex flex-col justify-between gap-6 min-h-[200px]">
              <div className="w-10 h-10 rounded-xl bg-neutral-100 dark:bg-white/[0.04] flex items-center justify-center">
                <svg className="w-5 h-5 text-slate-900 dark:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <div>
                <p className="text-4xl font-black text-slate-900 dark:text-white tracking-tight">&lt;10 min</p>
                <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Average setup time from signup to live chatbot</p>
              </div>
            </div>
            ...
            <div className="bg-primary-50 dark:bg-primary-900/20 rounded-3xl p-6 sm:p-8 flex flex-col justify-between gap-6 min-h-[180px]">
              ...
              <div className="flex flex-wrap gap-2 mt-4">
                {["PDF", "DOCX", "URL", "TXT", "MD"].map((t) => (
                  <span
                    key={t}
                    className="text-[10px] font-bold tracking-wider text-primary-700 dark:text-primary-300 bg-primary-100 dark:bg-teal-500/15 rounded-full px-3 py-1"
                  >
                    {t}
                  </span>
                ))}
      ...
      <section id="features" className="relative py-20 sm:py-24 lg:py-36 px-5 sm:px-6">
        <div className="max-w-6xl mx-auto">
          <div className="scroll-reveal grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            {/* Left: text list */}
            <div>
              <span className="text-xs font-medium uppercase tracking-widest text-slate-400 dark:text-slate-400 mb-4 block">
                Features
              </span>
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-slate-900 dark:text-white mb-8 sm:mb-12">
                Upload knowledge,
                <br />
                deploy instantly
              </h2>
              <div className="divide-y divide-neutral-200 dark:divide-white/[0.06]">
                {featureList.map((f) => (
                  <p
                    key={f}
                    className="py-4 sm:py-5 text-base sm:text-lg text-slate-700 dark:text-slate-300 font-medium"
                  >
                    {f}
                  </p>
                ))}
            ...
            <div className="relative hidden lg:block min-h-[500px]">
              ...
              <div className="absolute top-0 left-8 w-[320px] bg-white dark:bg-white/[0.02] rounded-2xl border border-neutral-200 dark:border-white/[0.06] shadow-xl shadow-neutral-200/50 overflow-hidden z-10">
                ...
                <div className="p-3 space-y-1.5">
                  {[
                    ...
                    <div
                      key={f.name}
                      className="flex items-center gap-2.5 bg-neutral-50 dark:bg-transparent rounded-lg px-3 py-2"
                    >
                      <div
                        className={`w-4 h-4 rounded flex-shrink-0 ${f.done ? "bg-primary-100 dark:bg-teal-500/15" : "bg-amber-100 dark:bg-amber-500/15"}`}
                      />
                      <span className="text-xs text-slate-700 dark:text-slate-300 flex-1 truncate">
                        {f.name}
                      </span>
                      <span
                        className={`text-[9px] font-semibold px-1.5 py-0.5 rounded-full ${f.done ? "text-emerald-700 dark:text-emerald-300 bg-emerald-50 dark:bg-emerald-500/10" : "text-amber-700 dark:text-amber-300 bg-amber-50 dark:bg-amber-500/10"}`}
                      >
              ...
              <div className="absolute top-32 right-0 w-[300px] bg-white dark:bg-white/[0.02] rounded-2xl border border-neutral-200 dark:border-white/[0.06] shadow-xl shadow-neutral-200/50 overflow-hidden z-20 rotate-2">
                ...
                <div className="p-4 space-y-2.5">
                  <div className="flex justify-end">
                    <div className="bg-teal-500 dark:bg-teal-400 text-white text-xs px-3 py-2 rounded-xl rounded-br-sm max-w-[75%]">
                      What&apos;s your refund policy?
                    </div>
                  </div>
                  <div className="flex justify-start">
                    <div className="bg-neutral-100 dark:bg-white/[0.04] text-slate-700 dark:text-slate-300 text-xs px-3 py-2 rounded-xl rounded-bl-sm max-w-[80%]">
              ...
              <div className="absolute bottom-16 left-16 bg-white dark:bg-white/[0.02] rounded-full border border-neutral-200 dark:border-white/[0.06] shadow-lg px-4 py-2.5 flex items-center gap-2 z-30 -rotate-3">
      ...
      {/* ═══════════ EMBED WIDGET ═══════════ */}
      <section className="relative py-20 sm:py-24 lg:py-36 px-5 sm:px-6 bg-neutral-50/70 dark:bg-white/[0.02] overflow-hidden">
        <div className="max-w-6xl mx-auto">
          <div className="scroll-reveal text-center mb-12 sm:mb-16">
            <span className="inline-block text-[11px] font-semibold uppercase tracking-widest text-slate-500 dark:text-slate-400 border border-neutral-200 dark:border-white/[0.06] rounded-full px-3 py-1 mb-5">
              Embed Widget
            </span>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-slate-900 dark:text-white mb-4 sm:mb-5">
          ...
          <div className="scroll-reveal relative max-w-5xl mx-auto">
            ...
            <div className="absolute -left-4 top-[30%] bg-white dark:bg-white/[0.02] rounded-full shadow-lg border border-slate-100 dark:border-white/[0.06] px-4 py-2 flex items-center gap-2 hidden lg:flex">
              <span className="w-2 h-2 rounded-full bg-teal-500 dark:bg-teal-400" />
              <span className="text-xs font-semibold text-slate-700 dark:text-slate-300">3 chat templates</span>
            </div>
            <div className="absolute -right-4 top-[20%] bg-white dark:bg-white/[0.02] rounded-full shadow-lg border border-slate-100 dark:border-white/[0.06] px-4 py-2 flex items-center gap-2 hidden lg:flex">
              <span className="w-2 h-2 rounded-full bg-emerald-500" />
              <span className="text-xs font-semibold text-slate-700 dark:text-slate-300">Live preview</span>
            </div>
            <div className="absolute -right-2 bottom-[25%] bg-white dark:bg-white/[0.02] rounded-full shadow-lg border border-slate-100 dark:border-white/[0.06] px-4 py-2 flex items-center gap-2 hidden lg:flex">
              <span className="w-2 h-2 rounded-full bg-amber-500" />
              <span className="text-xs font-semibold text-slate-700 dark:text-slate-300">Quick replies</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="platform" className="relative py-20 sm:py-24 lg:py-36 px-5 sm:px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="scroll-reveal grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 max-w-4xl mx-auto">
            ...
            {/* WordPress */}
            <div className="bg-neutral-50 dark:bg-transparent rounded-2xl p-6 flex flex-col items-center justify-center gap-3 aspect-square hover:bg-slate-100 dark:hover:bg-white/[0.04] transition-colors">
              <svg className="w-8 h-8 text-slate-900 dark:text-white" viewBox="0 0 24 24" fill="currentColor">
              ...
              <span className="text-xs font-semibold text-slate-600 dark:text-slate-400">WordPress</span>
            </div>
            ...
            <div className="bg-neutral-50 dark:bg-transparent rounded-2xl p-6 flex flex-col items-center justify-center gap-3 aspect-square hover:bg-slate-100 dark:hover:bg-white/[0.04] transition-colors">
              ...
              <span className="text-xs font-semibold text-slate-600 dark:text-slate-400">Shopify</span>
            </div>
            ...
            <div className="bg-neutral-50 dark:bg-transparent rounded-2xl p-6 flex flex-col items-center justify-center gap-3 aspect-square hover:bg-slate-100 dark:hover:bg-white/[0.04] transition-colors">
              ...
              <span className="text-xs font-semibold text-slate-600 dark:text-slate-400">React</span>
            </div>
            ...
            <div className="bg-neutral-50 dark:bg-transparent rounded-2xl p-6 flex flex-col items-center justify-center gap-3 aspect-square hover:bg-slate-100 dark:hover:bg-white/[0.04] transition-colors">
              ...
              <span className="text-xs font-semibold text-slate-600 dark:text-slate-400">Webflow</span>
            </div>
            ...
            <div className="bg-neutral-50 dark:bg-transparent rounded-2xl p-6 flex flex-col items-center justify-center gap-3 aspect-square hover:bg-slate-100 dark:hover:bg-white/[0.04] transition-colors">
              ...
              <span className="text-xs font-semibold text-slate-600 dark:text-slate-400">Next.js</span>
            </div>
            ...
            <div className="bg-neutral-50 dark:bg-transparent rounded-2xl p-6 flex flex-col items-center justify-center gap-3 aspect-square hover:bg-slate-100 dark:hover:bg-white/[0.04] transition-colors">
              ...
              <span className="text-xs font-semibold text-slate-600 dark:text-slate-400">HTML5</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="scroll-reveal">
              ...
              <p className="text-slate-500 dark:text-slate-400 leading-relaxed mb-8 max-w-md text-base sm:text-lg">
            ...
            >
              <div className="rounded-2xl overflow-hidden shadow-2xl shadow-neutral-300/40 border border-neutral-200 dark:border-white/[0.06]">
                <div className="bg-neutral-800 px-4 py-3 flex items-center gap-3">
                  ...
                  <span className="text-xs text-slate-500 dark:text-slate-400">index.html</span>
                </div>
                <div className="bg-neutral-900 p-4 sm:p-6 font-mono text-xs sm:text-sm text-slate-400 dark:text-slate-400 leading-relaxed overflow-x-auto">
      ...
      {/* ═══════════ VALUE PROPS ═══════════ */}
      <section className="relative py-12 sm:py-16 px-5 sm:px-6 border-y border-slate-100 dark:border-white/[0.06]">
        <div className="scroll-reveal max-w-4xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
          {[
            ...
            <div key={item.title}>
              ...
              <p className="text-sm text-slate-400 dark:text-slate-400 mt-1">{item.desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section id="pricing" className="relative py-20 sm:py-24 lg:py-36 px-5 sm:px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="scroll-reveal grid lg:grid-cols-5 gap-5 sm:gap-6 items-start">
            {/* Free — compact */}
            <div className="lg:col-span-2 rounded-3xl border border-neutral-200 dark:border-white/[0.06] bg-white dark:bg-white/[0.02] p-6 sm:p-8 lg:p-10">
              <p className="text-sm font-bold text-slate-900 dark:text-white mb-1">Free</p>
              ...
              <div className="flex items-baseline gap-1 mb-8">
                ...
                <span className="text-slate-400 dark:text-slate-400 text-sm">/month</span>
              </div>
              <Link
                href={ROUTES.COMPANY_REGISTER}
                className="w-full inline-flex items-center justify-center text-sm font-semibold text-slate-700 dark:text-slate-300 border border-neutral-200 hover:border-slate-300 dark:border-white/[0.10] dark:hover:border-white/[0.10] hover:bg-neutral-50 dark:hover:bg-white/[0.04] rounded-full h-12 transition-colors mb-8"
              >
                Get started
              </Link>
              <div className="space-y-3.5">
                {[
                  ...
                  <div key={f} className="flex items-start gap-3">
                    <svg
                      className="w-4 h-4 text-slate-400 dark:text-slate-400 mt-0.5 flex-shrink-0"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                      strokeWidth={2}
            ...
            <div className="lg:col-span-3 rounded-3xl bg-neutral-900 p-6 sm:p-8 lg:p-10 relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <Link
                  ...
                  className="w-full inline-flex items-center justify-center text-sm font-semibold bg-white hover:bg-slate-100 dark:hover:bg-white/[0.04] text-slate-900 dark:text-white rounded-full h-12 transition-colors mb-10"
                >
                    ...
                    <div className="space-y-2.5">
                      {[
                        ...
                        <div key={f} className="flex items-start gap-2.5">
                          ...
                          <span className="text-sm text-slate-300 dark:text-slate-600">{f}</span>
                        </div>
                      ))}
                    </div>
                  </div>
      ...
      <section id="faq" className="relative py-20 sm:py-24 lg:py-36 px-5 sm:px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="scroll-reveal divide-y divide-neutral-200 dark:divide-white/[0.06]">
            {faqs.map((faq, i) => (
              <div key={i}>
                <button
                ...
                >
                  <span className="text-[0.9375rem] font-medium text-slate-700 dark:text-slate-300 group-hover:text-slate-900 dark:group-hover:text-slate-50 transition-colors pr-4">
                    {faq.q}
                  </span>
                  <svg
                    className={`w-5 h-5 text-slate-300 dark:text-slate-600 flex-shrink-0 transition-transform duration-300 ${
        ...
        <div className="max-w-6xl mx-auto">
          <div className="scroll-reveal relative overflow-hidden rounded-3xl bg-neutral-900 px-6 py-14 sm:px-8 sm:py-16 lg:px-16 lg:py-24 text-center">
            ...
            <div className="relative">
              ...
              <p className="text-slate-400 dark:text-slate-400 max-w-md mx-auto mb-8 sm:mb-10 text-base sm:text-lg">
                Launch your AI-powered customer support in minutes.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link
                  href={isLoggedIn ? ROUTES.DASHBOARD : ROUTES.COMPANY_REGISTER}
                  className="inline-flex items-center justify-center text-sm sm:text-base font-semibold bg-white hover:bg-slate-100 dark:hover:bg-white/[0.04] text-slate-900 dark:text-white rounded-full h-12 sm:h-14 px-8 sm:px-10 transition-colors shadow-lg"
                >
                ...
                {!isLoggedIn && (
                  <Link
                    href={ROUTES.COMPANY_LOGIN}
                    className="inline-flex items-center justify-center text-sm font-medium text-slate-400 dark:text-slate-400 border border-neutral-700 hover:border-neutral-500 hover:text-white rounded-full h-11 sm:h-12 px-7 sm:px-8 transition-all"
                  >
                    I have an account
                  </Link>
                )}
      ...
      {/* ═══════════ FOOTER ═══════════ */}
      <footer className="border-t border-slate-100 dark:border-white/[0.06] py-12 lg:py-16 px-5 sm:px-6">
        <div className="max-w-6xl mx-auto">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-8">
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              <p className="text-sm text-slate-400 dark:text-slate-400 leading-relaxed max-w-xs">
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                <li><a href="#features" className="text-sm text-slate-400 dark:text-slate-400 hover:text-slate-600 dark:hover:text-slate-400 transition-colors">Features</a></li>
                <li><a href="#pricing" className="text-sm text-slate-400 dark:text-slate-400 hover:text-slate-600 dark:hover:text-slate-400 transition-colors">Pricing</a></li>
                <li><a href="#platform" className="text-sm text-slate-400 dark:text-slate-400 hover:text-slate-600 dark:hover:text-slate-400 transition-colors">Platforms</a></li>
                <li><a href="#faq" className="text-sm text-slate-400 dark:text-slate-400 hover:text-slate-600 dark:hover:text-slate-400 transition-colors">FAQ</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                <li><Link href={ROUTES.COMPANY_LOGIN} className="text-sm text-slate-400 dark:text-slate-400 hover:text-slate-600 dark:hover:text-slate-400 transition-colors">Login</Link></li>
                <li><Link href={ROUTES.COMPANY_REGISTER} className="text-sm text-slate-400 dark:text-slate-400 hover:text-slate-600 dark:hover:text-slate-400 transition-colors">Sign up</Link></li>
                <li><Link href={ROUTES.DASHBOARD} className="text-sm text-slate-400 dark:text-slate-400 hover:text-slate-600 dark:hover:text-slate-400 transition-colors">Dashboard</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                <li><Link href="/privacy" className="text-sm text-slate-400 dark:text-slate-400 hover:text-slate-600 dark:hover:text-slate-400 transition-colors">Privacy Policy</Link></li>
                <li><Link href="/terms" className="text-sm text-slate-400 dark:text-slate-400 hover:text-slate-600 dark:hover:text-slate-400 transition-colors">Terms of Service</Link></li>
              </ul>
            </div>
          </div>

          <div className="mt-12 pt-8 border-t border-slate-100 dark:border-white/[0.06] flex flex-col sm:flex-row items-center justify-between gap-4">
