  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex justify-end" onClick={onClose}>
      ...
      >
        ...
        <div className="flex items-start justify-between px-6 pt-5 pb-4 border-b border-neutral-100 flex-shrink-0">
          <div className="flex items-start gap-3 min-w-0">
            <div className="w-10 h-10 rounded-full bg-primary-50 flex items-center justify-center flex-shrink-0">
              <Icons.MessageCircle className="h-4 w-4 text-primary-600" />
            </div>
            <div className="min-w-0">
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <span className="inline-flex items-center px-1.5 py-0.5 rounded-full bg-neutral-100 text-neutral-600 text-[10px] font-semibold uppercase tracking-wider border border-neutral-200">
                  Anonymous
                </span>
              </div>
              {detail && (
        ...
        {/* Stats strip */}
        {detail && (
          <div className="grid grid-cols-2 border-b border-neutral-100 flex-shrink-0">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5 bg-neutral-50/40">
          {loading ? (
            ...
            <div className="h-full flex flex-col items-center justify-center text-center">
              <div className="h-10 w-10 rounded-full bg-error-50 flex items-center justify-center mb-3">
                <Icons.AlertTriangle className="h-5 w-5 text-error-500" />
              </div>
...
function DrawerStat({
  ...
  return (
    <div className="px-5 py-3 border-r border-neutral-100 last:border-r-0">
      ...
      <p
        className={`text-sm font-semibold mt-0.5 text-neutral-900 ${
          mono ? "font-mono" : ""
        }`}
      >
        {value}
