            ...
            <div className="flex items-center gap-2">
              <div
                className={`w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 ${
                  selected ? "bg-primary-600" : "bg-neutral-100 group-hover:bg-slate-200 dark:bg-white/[0.06] dark:group-hover:bg-white/[0.04]"
                }`}
              >
                <Icons.Mic
              ...
              <div className="flex-1 min-w-0">
                <p className={`text-sm font-semibold truncate ${selected ? "text-primary-900" : "text-slate-900 dark:text-white"}`}>
                  {v.name}
                </p>
